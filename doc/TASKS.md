...
## [x] Task 0: Project layout and baseline docs
...
## [x] Task 0b: Add `pyproject.toml` baseline
...
## [x] Task 1: Config loader and validation
...
## [x] Task 2: CLI entrypoint and command routing
...
## [x] Task 3: File-based transcription wrapper
...
## [x] Task 5: Audio capture and live transcription loop
...
## [x] Task 6: Daemon process and IPC
...
## [x] Task 7: Output writer and clipboard integration
...
## [x] Task 8: Optional post-processing
...
## [x] Task 10: Error handling and user-facing messages
...
## [x] Task 11: Final docs and handoff
